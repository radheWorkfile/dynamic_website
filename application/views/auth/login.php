            ...
            <div class="card-body">
                ...
                if ($_REQUEST['msg'] == 'invalid') {
                    echo '<div class="alert alert-warning">
                            Invalid Login Details!! Please Check Username, Password & User Type</div>';
                }
                ?>
                ...
                <form action="<?php echo base_url() ?>login/auth" method="post">
                    <div class="input-group mb-3">
                        <input type="email" class="form-control" name="email_id" value="<?php echo set_value('email_id') ?>" placeholder="Enter your ID">
