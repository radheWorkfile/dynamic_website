...
<body class="hold-transition sidebar-mini layout-fixed ">
                    ...
                    <table id="example" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Logo size</th>
                                <th> Logo Dimension (W X H)</th>   
                                <th>Status</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($logo as $us => $logo) { ?>
                                <tr>
                                    <td><?php echo $us + 1; ?></td>
                                   
                                    <td><?php echo $logo['logo_size']."KB" ?></td>
                                    <td><?php echo $logo['logo_width']."px X ".$logo['logo_height']."px"; ?></td>                                    
                                    <td>
                                        <?php echo ($logo['status']) == 1 ? "Active" : "Deactive"; ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0);" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#edit_modal" onclick="get_data_edit(<?php echo $logo['id'] ?>)" title='Click to Edit Data'><i class="fas fa-edit text-primary"></i></a>&emsp;

                                        <?php if($logo['status']==1):?>
                                            <a href="javascript:void(0);" onclick="deactivate(<?php echo $logo['id'];?>);" title="Deactivate logo"  class="text-danger" ><i class="fa fa-times"></i></a>
                                        <?php else:?>
                                            <a href="javascript:void(0);" onclick="activate(<?php echo $logo['id'];?>); " title="Activate logo" class="text-success" ><i class="fa fa-check"></i></a>
                                        <?php endif;?>
    ...
    <div class="modal fade" id="edit_modal">
        <div class="modal-dialog modal-sm">
            <div class="modal-content text-sm">
                <div class="modal-header">
                    <h5 class="modal-title">Update Logo properties</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script src="<?php echo  base_url() ?>media/js/super_admin/logo.js"></script>
