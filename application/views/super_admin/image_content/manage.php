...
<body class="hold-transition sidebar-mini layout-fixed ">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <table id="example" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach ($section as $us => $serv) { ?>
                                <tr>
                                    <td><?php echo $us + 1; ?></td>
                                    <td class="text-danger"><?php echo $serv['section_name'] ?></td>
                                    <td><?php echo $serv['max_limit'] ?></td>
                                    <td><?php echo $serv['image_size']."KB" ?></td>
                                    <td><?php echo $serv['image_width']."px X ".$serv['image_height']."px"; ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0);" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#edit_modal" onclick="get_data_edit(<?php echo $serv['id'] ?>)" title='Click to View Data'><i class="fas fa-edit text-primary"></i></a>&emsp;
    ...
    <div class="modal fade" id="edit_modal">
        <div class="modal-dialog modal-md">
            <div class="modal-content text-sm">
                <div class="modal-header">
                    <h5 class="modal-title">Update Section  Properties</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="update_section_properties" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    ...
    <script src="<?php echo  base_url() ?>media/js/super_admin/image_content.js"></script>
