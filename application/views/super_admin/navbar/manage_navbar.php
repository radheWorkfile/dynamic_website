...
<body class="hold-transition sidebar-mini layout-fixed ">
                        ...
                        <tbody>
                            <?php foreach ($navbar as $us => $nav) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $nav['navbar_limit'] ?></td>                                   

                                   
                                    <td>
                                       

                                        <a href="javascript:void(0);" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#edit_modal" onclick="get_data_edit_navbar(<?php echo $nav['id'] ?>)" title='Click to View  Data'><i class="fas fa-edit text-primary"></i></a>&emsp;
    ...
    <script>
        function get_data_edit_navbar(id)
        {
            $.ajax({
                url:"<?php echo base_url()."super_admin/navbar/get_navbar_data";?>",
                type:"POST",
                data:{'id': id },               
        ...
        $('#update_navbar').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: base_url+"super_admin/navbar/update_navbar",
                type: "POST",
