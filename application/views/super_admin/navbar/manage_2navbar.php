...
<body class="hold-transition sidebar-mini layout-fixed ">
                        ...
                        <tbody>
                            <?php foreach ($navbar as $us => $nav) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $nav['2nd_navbar_limit'] ?></td>
                                    <td>
                                        <?php echo ($nav['2nd_navbar_permission']) == 1 ? "Active" : "Deactive"; ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0);" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#edit_modal" onclick="get_data_edit_2navbar(<?php echo $nav['id'] ?>)" title='Click to View Data'><i class="fas fa-edit text-primary"></i></a>&emsp;


                                        <?php if ($nav['2nd_navbar_permission'] == 0) : ?>
    ...
    <div class="modal fade" id="edit_modal">
        <div class="modal-dialog modal-sm">
            <div class="modal-content text-sm">
                ...
                <form id="update_2navbar" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    ...
    <script>
        function get_data_edit_2navbar(id) {

            $.ajax({
                url: "<?php echo base_url() . "super_admin/navbar/get_2navbar_data"; ?>",
                type: "POST",
                data: {
                    'id': id
                },
        ...
        $('#update_2navbar').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: base_url + "super_admin/navbar/update_2navbar",
                type: "POST",
        ...
        {
           $.ajax({
            url: base_url +"super_admin/navbar/activate_2navbar",
            type:"post",
            data:{"id":id},
            success: function(data) {
                    //$('#empmsg').html(data);
        ...
        {
            $.ajax({
            url: base_url +"super_admin/navbar/deactivate_2navbar",
            type:"post",
            data:{"id":id},
            success: function(data) {
                    //$('#empmsg').html(data);
