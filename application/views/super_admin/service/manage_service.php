...
<body class="hold-transition sidebar-mini layout-fixed ">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <table id="example" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach ($service as $us => $serv) { ?>
                                <tr>
                                    <td><?php echo $us + 1; ?></td>
                                    <td><?php echo $serv['service_limit'] ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0);" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#edit_modal" onclick="get_data_edit_service(<?php echo $serv['id'] ?>)" title='Click to View Data'><i class="fas fa-edit text-primary"></i></a>&emsp;

                                        <?php if($serv['status']==1):?>
                                            <a href="javascript:void(0);" onclick="deactivate(<?php echo $serv['id'];?>);" title="Deactivate service card"  class="text-danger" ><i class="fa fa-times"></i></a>
                                        <?php else:?>
                                            <a href="javascript:void(0);" onclick="activate(<?php echo $serv['id'];?>); " title="Activate service card" class="text-success" ><i class="fa fa-check"></i></a>
                                        <?php endif;?>
    ...
    <div class="modal fade" id="edit_modal">
        <div class="modal-dialog modal-sm">
            <div class="modal-content text-sm">
                <div class="modal-header">
                    <h5 class="modal-title">Update Service properties</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="update_service" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    ...
    <script src="<?php echo  base_url() ?>media/js/super_admin/service.js"></script>
